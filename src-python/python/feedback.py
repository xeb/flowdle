...
class FeedbackHandler(webapp.RequestHandler):
    def get(self):
        self.response.out.write(unicode(template.render('templates/feedback.html', None))) 
    ...
    def post(self):
        ...
        message.send()
        self.response.out.write(unicode(template.render('templates/thankyou.html', None)))
